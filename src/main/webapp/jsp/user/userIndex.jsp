...
<div class="container-fluid">
    <div class="row layui-bg-gray" style="height: 30px;line-height:30px;">
        ...
        <div class="col-md-5">
            <span style="margin:0 10px"><a href="${ pageContext.request.contextPath }/user/userInfo.jsp">个人信息</a></span>
...
<div style="width:90%;margin:auto;">
    ...
    <div class="row" style="font-size:large;">
        <div class="col-md-1"></div>
        <div class="col-md-2"><a href="${ pageContext.request.contextPath }/doctor/findAllDoctors">在线问诊</a></div>
